...
#EJEMPLO
@app.get('/') #Un decorador, lleva la ruta donde podran ingresar desde la web. De esta forma creamos nuestro primer recurso que se vera desde al web. Esta será la ruta principal
def generate_list(): #metodo que nos volvera una lista de nombres
    return ['Otoniel','Daniel','Mardoqueo','Jonas','Judas','Joel','Urias' ]
