...
def get_categories():
    r = requests.get('https://api.escuelajs.co/api/v1/categories') #aca hacemos la peticion para que nos traiga la informacion de las categorias, en la variable r se almacenara el resultado
